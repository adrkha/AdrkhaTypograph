...
Source: "bin\Release\AdrkhaTypograph.dll.manifest";     DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
Source: "bin\Release\AdrkhaTypograph.vsto";             DestDir: "{app}"; Flags: ignoreversion skipifsourcedoesntexist
